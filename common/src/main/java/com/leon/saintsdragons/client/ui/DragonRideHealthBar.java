...
public class DragonRideHealthBar {
    ...
    private static final ResourceLocation STEGONAUT_BASE = SaintsDragonsCommon.rl("textures/gui/healthbar/stegonaut/stegonaut_base.png");
    private static final ResourceLocation STEGONAUT_OVERLAY = SaintsDragonsCommon.rl("textures/gui/healthbar/stegonaut/stegonaut_overlay.png");
