...
/**
 * NeoForge-specific implementation of dragon hitbox parts using NeoForge's PartEntity system.
 * Supports both standard centered boxes and elongated boxes that stretch toward a target point.
 */
public class NeoForgeDragonPart extends PartEntity<Entity> {
    ...
    public NeoForgeDragonPart(Entity parent, String partName, float width, float height) {
        super(parent);
    ...
    public NeoForgeDragonPart setDamageMultiplier(float multiplier) {
