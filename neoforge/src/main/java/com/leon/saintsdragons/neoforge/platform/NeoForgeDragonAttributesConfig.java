...
/**
 * NeoForge dragon attributes configuration.
 * Builds a ModConfigSpec for all dragon attributes including health, armor, speeds, abilities, and taming.
 *
 * Note: walk_speed and run_speed are hardcoded for AI/rider compatibility and are NOT configurable.
 * Note: Stegonaut has no configurable attributes (all hardcoded).
 */
